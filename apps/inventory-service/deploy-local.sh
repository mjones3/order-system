...
### Configuration
APP_NAME="inventory-service-app"
APP_DOCKERFILE="Dockerfile"           # adjust if you have a custom path
APP_IMAGE="${APP_NAME}:latest"
APP_CONTAINER="${APP_NAME}-ctr"

# Postgres settings
PG_CONTAINER="inventory-service-pg"
PG_IMAGE="postgres:17-alpine"
PG_NETWORK="inventory-network"
PG_VOLUME="inventory-pgdata"
PG_DB="inventorydb"
PG_USER="inventoryuser"
PG_PASS="inventorypass"
PG_PORT=5433
